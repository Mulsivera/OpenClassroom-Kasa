...
function Collapse ({collapseTitle, collapseContent}) {
    ...
    return (
        <div className="[ collapse__div ] [ f-column ] [ align-item-center ]">
            <div className="[ collapse__title__div ] [ background-color-red ] [ flex-row ] [ justify-between ] [ align-item-center ]">
                <p className="[ collapse__title__text ] [ text-color-white ] [ font-weight-700 ]">{collapseTitle}</p>
